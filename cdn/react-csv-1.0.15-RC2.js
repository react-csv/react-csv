...
})(
  {
    1: [
      function(require, module, exports) {
        ...
        window.ReactCSV = {
          CSVLink: ReactCSV.CSVLink,
          CSVDownload: ReactCSV.CSVDownload,
        };
      },
      { "../lib/index": 5 },
    ],
            ...
            },
            {
              ...
              value: function handleLegacy(
                ...
                if (window.navigator.msSaveOrOpenBlob) {
                  ...
                  var blob = new Blob([
                    (0, _core.toCSV)(data, headers, separator),
                  ]);
    ...
    4: [
      function(require, module, exports) {
        ...
        var jsonsHeaders = (exports.jsonsHeaders = function jsonsHeaders(
          array
        ) {
          return Array.from(
            array
...
function factory(ReactComponent, isValidElement, ReactNoopUpdateQueue) {
  ...
  function validateTypeDef(Constructor, typeDef, location) {
    ...
    5: [
      ...
      { "./components/Download": 2, "./components/Link": 3 },
    ],
    6: [
      function(require, module, exports) {
        "use strict";
...
*/
    ...
    21: [
      ...
      { "./reactProdInvariant": 42, _process: 13, "fbjs/lib/invariant": 10 },
    ],
    22: [
      function(require, module, exports) {
        (function(process) {
      ...
      },
      {
        "./ReactBaseClasses": 23,
        "./ReactChildren": 24,
        "./ReactDOMFactories": 27,
        "./ReactElement": 28,
        "./ReactElementValidator": 30,
        "./ReactPropTypes": 33,
        "./ReactVersion": 35,
        "./canDefineProperty": 36,
        "./createClass": 38,
        "./lowPriorityWarning": 40,
        "./onlyChild": 41,
        _process: 13,
        "object-assign": 12,
      },
    ...
    23: [
      ...
      {
        "./ReactNoopUpdateQueue": 31,
        "./canDefineProperty": 36,
        "./lowPriorityWarning": 40,
        "./reactProdInvariant": 42,
        _process: 13,
        "fbjs/lib/emptyObject": 9,
        "fbjs/lib/invariant": 10,
        "object-assign": 12,
    ...
    27: [
      ...
      { "./ReactElement": 28, "./ReactElementValidator": 30, _process: 13 },
    ],
    28: [
      function(require, module, exports) {
        (function(process) {
    ...
    31: [
      ...
      { _process: 13, "fbjs/lib/warning": 11 },
    ],
    32: [
      function(require, module, exports) {
        (function(process) {
    ...
    33: [
      ...
      { "./ReactElement": 28, "prop-types/factory": 15 },
    ],
    34: [
      function(require, module, exports) {
        /**
